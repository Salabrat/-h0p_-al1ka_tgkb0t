...
def main_menu_kb():
    ...
    buttons = [
        KeyboardButton("🏪 Каталог товаров", request_contact=False, request_location=False),
        KeyboardButton("💳 Пополнить баланс", request_contact=False, request_location=False),
        KeyboardButton("👤 Мой профиль", request_contact=False, request_location=False),
        KeyboardButton("📞 Связаться", request_contact=False, request_location=False),
        KeyboardButton("🎁ПОЛУЧИ БОНУСЫ🎁", request_contact=False, request_location=False)
    ]
